...
export function EvidenceDocument({
  ...
  // `vehicle` is null on a flight or a cruise; `item` carries the
  // equivalent. Never drop the line — this is the packet a chargeback is
  // defended with, and it has to say what was sold.
  ...
  return (
    ...
    >
      <Page size="A4" style={styles.page}>
        ...
        {vehicle ? (
          <Row label="Vehicle" value={`${vehicle.company} · ${vehicle.type}`} />
        ) : (
        ...
        <View style={styles.imagesRow}>
          ...
          {vehicle?.imageUrl ? (
            <View style={styles.imageTile}>
              ...
              <Image src={vehicle.imageUrl} style={styles.imageTileImg} />
