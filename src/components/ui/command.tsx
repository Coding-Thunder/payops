...
/**
 * shadcn-style Command primitive built on cmdk. Used by the global
 * command palette and any inline command list (e.g. type-ahead combobox).
 */
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List
    ref={ref}
    className={cn(
      "max-h-[360px] overflow-y-auto overflow-x-hidden scrollbar-thin",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ...
    className={cn(
      ...
      "data-[selected=true]:bg-surface-1 data-[selected=true]:text-foreground",
...
const CommandShortcut = ({
  ...
  <span
    className={cn(
      "ml-auto text-[10.5px] tracking-wider text-muted-foreground tabular-nums",
      className,
    )}
    {...props}
  />
