...
import { getUserDetail } from "@/console/server/services/users";
...
import { UserSupportActions } from "@/console/components/user-support-actions";
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <Link href={`${ADMIN_BASE}/users`} className="text-[12px] text-[var(--muted)] hover:text-slate-200">
            ← Users
          </Link>
