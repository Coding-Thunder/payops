      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="bg-gradient-to-br from-amber-50 via-white to-white px-8 pt-10 pb-8 text-center">
          ...
          <p className="mt-2 text-sm text-slate-600">
            You closed the secure payment window before finishing.{" "}
            {brand.brandName} has not charged your card. You can use the same
            payment link to try again, or ask us to send a new one.
          </p>
        </div>
